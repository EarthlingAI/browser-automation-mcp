...
Cross-tab Chrome control via a passive MV3 extension. 20 tools that drive the user's real authenticated browser without ever raising the window or stealing focus. 24 invariants govern the design — see "Key Invariants" below.
